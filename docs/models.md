...
* InternLM (`InternLMForCausalLM`, `InternLM2ForCausalLM`)
    ...
    * [x] v2.5: [Chat-7B](https://huggingface.co/internlm/internlm2_5-7b-chat), [Chat-7B-1M](https://huggingface.co/internlm/internlm2_5-7b-chat-1m)
...
* Gemma (`GemmaForCausalLM`)
    ...
    * [x] v2: [Instruct-9B](https://huggingface.co/google/gemma-2-9b-it), [Instruct-27B](https://huggingface.co/google/gemma-2-27b-it)
