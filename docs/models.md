...
* LlaMA-like (`LlamaForCausalLM`, `Llama4ForConditionalGeneration`):
    ...
    * [x] MiniCPM5: [1B](https://huggingface.co/openbmb/MiniCPM5-1B/tree/4e9de7a0778dc1c362e983e6858f0e77542cbdca),
    [2B](https://huggingface.co/openbmb/MiniCPM5-2B/tree/3497c460c89e00520c3cfa2e73f49ab7647f1177) (`-a MiniCPM5`)
...
* [Jacobian Lens models](https://huggingface.co/neuronpedia/jacobian-lens/tree/a4114d7752d11eb546e6cf372213d7e75526d3a1)

    See ["Introspection" with lens](lens.md).