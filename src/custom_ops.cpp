...
static void ggml_compute_forward_su_rope_f16(struct ggml_tensor * dst , const struct ggml_tensor * a, const struct ggml_tensor * b, int ith, int nth, void * userdata)
{
...
static void ggml_compute_forward_su_rope_f32(struct ggml_tensor * dst , const struct ggml_tensor * a, const struct ggml_tensor * b, int ith, int nth, void * userdata)
{
    Phi3SUSelfAttention *data = reinterpret_cast<Phi3SUSelfAttention *>(userdata);
...
static void ggml_compute_forward_su_rope(struct ggml_tensor * dst , const struct ggml_tensor * a, const struct ggml_tensor * b, int ith, int nth, void * userdata)
{
    switch (a->type)
    {
    case GGML_TYPE_F16:
...
static void ggml_compute_forward_inv_freq_scale_rope_f32(struct ggml_tensor * dst , const struct ggml_tensor * a, const struct ggml_tensor * b, int ith, int nth, void * userdata)
{
    CustomInvFreqScalingRope *data = reinterpret_cast<CustomInvFreqScalingRope *>(userdata);
...
static void ggml_compute_forward_inv_freq_scale_rope_f16(struct ggml_tensor * dst , const struct ggml_tensor * a, const struct ggml_tensor * b, int ith, int nth, void * userdata)
{
    CustomInvFreqScalingRope *data = reinterpret_cast<CustomInvFreqScalingRope *>(userdata);
...
void ggml_compute_forward_inv_freq_scaling_rope(struct ggml_tensor * dst , const struct ggml_tensor * a, const struct ggml_tensor * b, int ith, int nth, void * userdata)
{
    ...
    {
    case GGML_TYPE_F16:
        ggml_compute_forward_inv_freq_scale_rope_f16(dst, a, b, ith, nth, userdata);
        break;
    case GGML_TYPE_F32:
        ggml_compute_forward_inv_freq_scale_rope_f32(dst, a, b, ith, nth, userdata);
        break;
    default:
        GGML_ASSERT(false);
        break;
